...
public class JmsPutGet {
	...
	public static void main(String[] args) {
        ...
        if (args.length == 5) {
           ...
           System.out.println("java JmsPutGet localhost 1414 DEV.APP.SVRCONN QM1 DEV.QUEUE.1 \n");     
           System.exit(0);    
        }   
		...
		try {
			...
			//cf.setStringProperty(WMQConstants.WMQ_SSL_CIPHER_SPEC, "TLS_RSA_WITH_AES_128_CBC_SHA256");
